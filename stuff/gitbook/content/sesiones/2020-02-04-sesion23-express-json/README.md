# Sesion 23 - Express JSON (04-02-2020) 

{% video %}https://vimeo.com/390760257{% endvideo %}
...
{% github_embed "https://github.com/trainings-juanmaguitar/leadtech-training-node-js-oct2019/blob/master/stuff/code/express/expressworks/4-GOOD-OLD-FORM.js" %}{% endgithub_embed %}

---

```
Create a mini site w/ 2 pages:
- Home 
	→ GET /home
- Contact (/contact) 
	- GET /contact (display form)
	- POST /contact (capture data and display confirmation (template))
Both pages should display a HTML page rendered from the server (pug)
Contact page should display a form able to capture the data sent in the form and returning a confirmation page with the data sent
...
{% github_embed "https://github.com/trainings-juanmaguitar/leadtech-training-node-js-oct2019/blob/master/stuff/code/express/mini-project-form/index.js" %}{% endgithub_embed %}

---

{% github_embed "https://github.com/trainings-juanmaguitar/leadtech-training-node-js-oct2019/blob/master/stuff/code/express/mini-project-form/views/home.pug" %}{% endgithub_embed %}

---

{% github_embed "https://github.com/trainings-juanmaguitar/leadtech-training-node-js-oct2019/blob/master/stuff/code/express/mini-project-form/views/contact.pug" %}{% endgithub_embed %}

---

{% github_embed "https://github.com/trainings-juanmaguitar/leadtech-training-node-js-oct2019/blob/master/stuff/code/express/mini-project-form/views/confirmation.pug" %}{% endgithub_embed %}
